...
import time
import math
from mysim_h_one_rroute_trace import *
import argparse
...
if __name__ == '__main__':
    ...
    src_dir, topo_dir, topo, trace = args.src_dir, args.topo_dir, args.topo, args.trace
    ...
    exec_sim = ExecSim(net_name, src_dir, topo_dir, topo, traffic, ij_rate, num_vcs, True, trace)
    acc_ij_rate, avg_lat = exec_sim.execsim()
    print("acc_ij_rate", acc_ij_rate)

    rlog_name = "%.15f_%f_%s_%s_%d.rlog" % (ij_rate, end_lat, topo, trace, num_vcs)
