...
class ExecSim:
    ...
    def execsim(self):
        ...
        bp = BsimOpen(net_name, src_dir, topo_dir, topo, traffic, ij_rate, num_vcs, use_trace_file, trace_file, "deadlock", 300)
...
class BsimOpen:
    ...
    def bsim_open(self):
        ...
        cfg_to_write = CFG_TEMPLATE % (net_name, "%s.tp" % topo_path, "%s.txt" % topo_path, traffic, ij_rate, num_vcs, utrace_int, trace)
        print(cfg_to_write)
